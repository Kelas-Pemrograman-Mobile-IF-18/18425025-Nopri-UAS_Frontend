...
public class bonekaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newsList.clear();
        adapter = new adapterbarang(bonekaActivity.this, newsList);
    ...
    public void onBackPressed() {
        Intent i = new Intent(bonekaActivity.this, dashboard_user.class);
        startActivity(i);
        finish();
    }
    ...
    private void getAllBarang() {
        ...
        showDialog();
        JsonObjectRequest req = new JsonObjectRequest(Request.Method.GET, BaseURL.databarangBoneka, null,
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            ...
                                            Intent a = new Intent(bonekaActivity.this, detailpembeli.class);
