...
public class pesanan_user extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newsList.clear();
        adapter = new adapterorder(pesanan_user.this, newsList);
        list.setAdapter(adapter);
        getAllOrder();
    }
    @Override
    public void onBackPressed() {
        Intent i = new Intent(pesanan_user.this, dashboard_user.class);
        startActivity(i);
        finish();
    }
                                    ...
                                    list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            ...
                                            if (newsList.get(position).getStatus().equals("Proses Pengiriman")) {
                                                ...
                                                AlertDialog.Builder builder = new AlertDialog.Builder(pesanan_user.this);
...
//                                                    hapusData();
                                                        ...
                                                        Toast.makeText(getApplicationContext(), "Berhasil Transaksi", Toast.LENGTH_LONG).show();
                                                    }
                                                });
