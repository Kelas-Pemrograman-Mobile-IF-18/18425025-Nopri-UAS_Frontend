...
import com.nopri.penjualanmainan.admin.ActivityDataBarang;
import com.nopri.penjualanmainan.admin.EditdanDeleteAc;
...
public class actionfiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_actionfi);
        ...
        newsList.clear();
        adapter = new adapterbarang(actionfiActivity.this, newsList);
    ...
    public void onBackPressed() {
        Intent i = new Intent(actionfiActivity.this, dashboard_user.class);
        startActivity(i);
        finish();
    }
    ...
    private void getAllBarang() {
        ...
        showDialog();
        JsonObjectRequest req = new JsonObjectRequest(Request.Method.GET, BaseURL.databarangAction, null,
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            ...
                                            Intent a = new Intent(actionfiActivity.this, detailpembeli.class);
