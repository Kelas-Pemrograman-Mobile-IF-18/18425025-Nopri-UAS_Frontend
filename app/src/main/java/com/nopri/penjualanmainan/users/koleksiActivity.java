...
public class koleksiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newsList.clear();
        adapter = new adapterbarang(koleksiActivity.this, newsList);
    ...
    public void onBackPressed() {
        Intent i = new Intent(koleksiActivity.this, dashboard_user.class);
        startActivity(i);
        finish();
    }
    ...
    private void getAllBarang() {
        ...
        showDialog();
        JsonObjectRequest req = new JsonObjectRequest(Request.Method.GET, BaseURL.databarangKoleksi, null,
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            ...
                                            Intent a = new Intent(koleksiActivity.this, detailpembeli.class);
